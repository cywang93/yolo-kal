...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        self.model = self.model_load(weights="runs/train/exp28/weights/best.pt",
    ...
    def model_load(self, weights="",  # model.pt path(s)
        ...
        # print(model.onnx)
        print("The model is loaded and the model information is as above!")
        return model
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        self.webcam_detection_btn = QPushButton("Real-time camera monitoring")
        self.mp4_detection_btn = QPushButton("Video detection")
        self.vid_stop_btn = QPushButton("Stop detecting")
        ...
        about_title = QLabel('YOLOV5-based target detection system\n'
                             '')  # todo 修改欢迎词语
        about_title.setFont(QFont('楷体', 18))
        about_title.setAlignment(Qt.AlignCenter)
        about_img = QLabel()
        about_img.setPixmap(QPixmap('images/UI/KAL1.jpg'))
        about_img.setAlignment(Qt.AlignCenter)
        label_super = QLabel()  # todo 更换作者信息
        label_super.setText("KAL1")
        ...
        self.addTab(about_widget, 'Homepage')
    ...
    def detect_img(self):
        ...
        print(source)
        if source == "":
            QMessageBox.warning(self, "Please upload", "Please upload the picture first before detection")
        else:
            source = str(source)
